...
class CausalTransformerDecoder(TransformerDecoder):
    ...
    def forward(self, tgt, src, cache=None, causal=False, dropout_p=0., dropout_h=0.):
...
class CausalTransformerDecoderLayer(TransformerDecoderLayer):
    def forward(self, tgt, src, tgt_mask=None, causal=False, dropout_p=0., dropout_h=0.):

        if not causal:
            return super().forward(tgt, src, tgt_mask=tgt_mask, dropout_p=dropout_p, dropout_h=dropout_h)
